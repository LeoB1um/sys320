#Gets the shutdown records from windows events and saves to a variabe 
#gets the last 500 days.

$shutdowns = Get-EventLog System -After (Get-Date).AddDays(-25) | where {$_.EventID -eq "6006"} 
